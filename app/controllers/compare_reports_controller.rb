class CompareReportsController < ApplicationController
	...
	def request_comparation
		...
		@first_report = verify_params_of_test_type(params[:first_year],params[:grade],params[:first_state],params[:first_test_type],params[:first_public_type],params[:first_local])
